...
**Note:** Please check out the [v2-beta](https://github.com/DiscoverITLLC/MagicMirror/tree/v2-beta) branch if you are looking for a modular system with simple installer.
