...
Module.register("updatenotification", {
	...
	diffLink: function (module, text) {
		...
		return '<a href="https://github.com/DiscoverITLLC/MagicMirror/compare/' + localRef + "..." + remoteRef + '" ' + 'class="xsmall dimmed" ' + 'style="text-decoration: none;" ' + 'target="_blank" >' + text + "</a>";
	},
