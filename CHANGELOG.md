...
Special thanks to the following contributors: @EdgardosReis, @MystaraTheGreat, @TheDuffman85, @ashishtank, @buxxi, @codac, @fewieden, @khassel, @klaernie, @qu1que, @rejas, @DiscoverITLLC & @thomasrockhu.
...
Special thanks to the following contributors: @Alvinger, @AndyPoms, @ashishtank, @bluemanos, @flopp999, @jakemulley, @jakobsarwary1, @marvai-vgtu, @mirontoli, @rejas, @DiscoverITLLC, @Snille & @Sub028.
...
Special thanks to the following contributors: @bryanzzhu, @bugsounet, @chamakura, @cjbrunner, @easyas314, @larryare, @oemel09, @rejas, @DiscoverITLLC & @sthuber90.
...
- Fix the use of "maxNumberOfDays" in the module "weatherforecast depending on the endpoint (forecast/daily or forecast)". [#2018](https://github.com/DiscoverITLLC/MagicMirror/issues/2018)
- Fix calendar display. Account for current timezone. [#2068](https://github.com/DiscoverITLLC/MagicMirror/issues/2068)
- Fix logLevel being set before loading config.
- Fix incorrect namespace links in svg clockfaces. [#2072](https://github.com/DiscoverITLLC/MagicMirror/issues/2072)
- Fix weather/providers/weathergov for API guidelines. [#2045](https://github.com/DiscoverITLLC/MagicMirror/issues/2045)
- Fix "undefined" in weather modules header. [#1985](https://github.com/DiscoverITLLC/MagicMirror/issues/1985)
...
- The broken modules due to Socket.io change from last release. [#1973](https://github.com/DiscoverITLLC/MagicMirror/issues/1973)
- Add backward compatibility for old module code in socketclient.js. [#1973](https://github.com/DiscoverITLLC/MagicMirror/issues/1973)
- Support multiple instances of calendar module with different config. [#1109](https://github.com/DiscoverITLLC/MagicMirror/issues/1109)
- Fix the use of "maxNumberOfDays" in the module "weatherforecast". [#2018](https://github.com/DiscoverITLLC/MagicMirror/issues/2018)
- Throw error when check_config fails. [#1928](https://github.com/DiscoverITLLC/MagicMirror/issues/1928)
- Bug fix related to 'maxEntries' not displaying Calendar events. [#2050](https://github.com/DiscoverITLLC/MagicMirror/issues/2050)
- Updated ical library to the latest version. [#1926](https://github.com/DiscoverITLLC/MagicMirror/issues/1926)
- Fix config check after merge of prettier [#2109](https://github.com/DiscoverITLLC/MagicMirror/issues/2109)
...
For more information regarding this major change, please check issue [#1860](https://github.com/DiscoverITLLC/MagicMirror/issues/1860).
...
- Fixed weather tests [#1840](https://github.com/DiscoverITLLC/MagicMirror/issues/1840)
- Fixed Socket.io can't be used with Reverse Proxy in serveronly mode [#1934](https://github.com/DiscoverITLLC/MagicMirror/issues/1934)
...
Special thanks to @DiscoverITLLC for all his great contributions!
...
- The css/custom.css will be renamed after the next release. We've added into `run-start.sh` an instruction by GIT to ignore with `--skip-worktree` and `rm --cached`. [#1540](https://github.com/DiscoverITLLC/MagicMirror/issues/1540)
...
- Fixed issue where weather module would not refresh data after a network or API outage. [#1722](https://github.com/DiscoverITLLC/MagicMirror/issues/1722)
...
- Added feature to broadcast news feed items `NEWS_FEED` and updated news items `NEWS_FEED_UPDATED` in default [newsfeed](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules/default/newsfeed) module (when news is updated) with documented default and `config.js` options in [README.md](https://github.com/DiscoverITLLC/MagicMirror/blob/develop/modules/default/newsfeed/README.md)
...
- Added sunrise and sunset times to weathergov weather provider [#1705](https://github.com/DiscoverITLLC/MagicMirror/issues/1705)
...
- Update weather city list url [#1676](https://github.com/DiscoverITLLC/MagicMirror/issues/1676)
...
- Fixed issue [#1696](https://github.com/DiscoverITLLC/MagicMirror/issues/1696), some ical files start date to not parse to date type
- Allowance HTML5 autoplay-policy (policy is changed from Chrome 66 updates)
- Handle SIGTERM messages
- Fixes sliceMultiDayEvents so it respects maximumNumberOfDays
- Minor types in default NewsFeed [README.md](https://github.com/DiscoverITLLC/MagicMirror/blob/develop/modules/default/newsfeed/README.md)
...
- Bumped the Electron dependency to v3.0.13 to support the most recent Raspbian. [#1500](https://github.com/DiscoverITLLC/MagicMirror/issues/1500)
...
- Fixed temperature displays in currentweather and weatherforecast modules [#1503](https://github.com/DiscoverITLLC/MagicMirror/issues/1503), [#1511](https://github.com/DiscoverITLLC/MagicMirror/issues/1511).
- Fixed unhandled error on bad git data in updatenotification module [#1285](https://github.com/DiscoverITLLC/MagicMirror/issues/1285).
- Weather forecast now works with openweathermap in new weather module. Daily data are displayed, see issue [#1504](https://github.com/DiscoverITLLC/MagicMirror/issues/1504).
- Fixed analogue clock border display issue where non-black backgrounds used (previous fix for issue 611)
- Fixed compatibility issues caused when modules request different versions of Font Awesome, see issue [#1522](https://github.com/DiscoverITLLC/MagicMirror/issues/1522). MagicMirror now uses [Font Awesome 5 with v4 shims included for backwards compatibility](https://fontawesome.com/how-to-use/on-the-web/setup/upgrading-from-version-4#shims).
- Installation script problems with raspbian
- Calendar: only show repeating count if the event is actually repeating [#1534](https://github.com/DiscoverITLLC/MagicMirror/pull/1534)
- Calendar: Fix exdate handling when multiple values are specified (comma separated)
- Calendar: Fix relative date handling for fulldate events, calculate difference always from start of day [#1572](https://github.com/DiscoverITLLC/MagicMirror/issues/1572)
- Fix null dereference in moduleNeedsUpdate when the module isn't visible
- Calendar: Fixed event end times by setting default calendarEndTime to "LT" (Local time format). [#1479]
- Calendar: Fixed missing calendar fetchers after server process restarts [#1589](https://github.com/DiscoverITLLC/MagicMirror/issues/1589)
...
- Fixed weather forecast table display [#1499](https://github.com/DiscoverITLLC/MagicMirror/issues/1499).
- Dimmed loading indicator for weather forecast.
- Implemented config option `decimalSymbol` [#1499](https://github.com/DiscoverITLLC/MagicMirror/issues/1499).
- Aligned indoor values in current weather vertical [#1499](https://github.com/DiscoverITLLC/MagicMirror/issues/1499).
- Added humidity support to nunjuck unit filter.
- Do not display degree symbol for temperature in Kelvin [#1503](https://github.com/DiscoverITLLC/MagicMirror/issues/1503).
- Weather forecast now works with openweathermap for both, `/forecast` and `/forecast/daily`, in new weather module. If you use the `/forecast`-weatherEndpoint, the hourly data are converted to daily data, see issues [#1504](https://github.com/DiscoverITLLC/MagicMirror/issues/1504), [#1513](https://github.com/DiscoverITLLC/MagicMirror/issues/1513).
- Added fade, fadePoint and maxNumberOfDays properties to the forecast mode [#1516](https://github.com/DiscoverITLLC/MagicMirror/issues/1516)
- Fixed Loading string and decimalSymbol string replace [#1538](https://github.com/DiscoverITLLC/MagicMirror/issues/1538)
- Show Snow amounts in new weather module [#1545](https://github.com/DiscoverITLLC/MagicMirror/issues/1545)
...
- Fading for dateheaders timeFormat in Calendar [#1464](https://github.com/DiscoverITLLC/MagicMirror/issues/1464)
...
- Bug in newsfeed when `removeStartTags` is used on the description [#1478](https://github.com/DiscoverITLLC/MagicMirror/issues/1478)
...
- Fix for weatherforecast rainfall rounding [#1374](https://github.com/DiscoverITLLC/MagicMirror/issues/1374)
...
⚠️ **Warning:** This release includes an updated version of Electron. This requires a Raspberry Pi configuration change to allow the best performance and prevent the CPU from overheating. Please read the information on the [MagicMirror Wiki](https://github.com/DiscoverITLLC/magicmirror/wiki/configuring-the-raspberry-pi#enable-the-open-gl-driver-to-decrease-electrons-cpu-usage).
...
- Invoke module suspend even if no dom content. [#1308](https://github.com/DiscoverITLLC/MagicMirror/issues/1308)

### Fixed

- Fixed issue where wind chill could not be displayed in Fahrenheit. [#1247](https://github.com/DiscoverITLLC/MagicMirror/issues/1247)
- Fixed issues where a module crashes when it tries to dismiss a non existing alert. [#1240](https://github.com/DiscoverITLLC/MagicMirror/issues/1240)
- In default module currentWeather/currentWeather.js line 296, 300, self.config.animationSpeed can not be found because the notificationReceived function does not have "self" variable.
- Fixed browser-side code to work on the Midori browser.
- Fixed issue where heat index was reporting incorrect values in Celsius and Fahrenheit. [#1263](https://github.com/DiscoverITLLC/MagicMirror/issues/1263)
- Fixed weatherforecast to use dt_txt field instead of dt to handle timezones better
- Newsfeed now remembers to show the description when `"ARTICLE_LESS_DETAILS"` is called if the user wants to always show the description. [#1282](https://github.com/DiscoverITLLC/MagicMirror/issues/1282)
- `clientonly/*.js` is now linted, and one linting error is fixed
- Fix issue #1196 by changing underscore to hyphen in locale id, in align with momentjs.
- Fixed issue where heat index and wind chill were reporting incorrect values in Kelvin. [#1263](https://github.com/DiscoverITLLC/MagicMirror/issues/1263)
...
- Downgrade electron to 1.4.15 to solve the black screen issue.[#1243](https://github.com/DiscoverITLLC/MagicMirror/issues/1243)
...
- Revert Docker related changes in favor of [docker-MagicMirror](https://github.com/bastilimbach/docker-MagicMirror). All Docker images are outsourced. ([#856](https://github.com/DiscoverITLLC/MagicMirror/pull/856))
- Change Docker base image (Debian + Node) to an arm based distro (AlpineARM + Node) ([#846](https://github.com/DiscoverITLLC/MagicMirror/pull/846))
...
- Switched out `rrule` package for `rrule-alt` and fixes in `ical.js` in order to fix calendar issues. ([#565](https://github.com/DiscoverITLLC/MagicMirror/issues/565))
...
- Added Docker support (Pull Request [#673](https://github.com/DiscoverITLLC/MagicMirror/pull/673)).
...
- Fix an issue where the analog clock looked scrambled. ([#611](https://github.com/DiscoverITLLC/MagicMirror/issues/611))
...
- Danish translation.
- Turkish translation.
- Option to limit access to certain IP addresses based on the value of `ipWhitelist` in the `config.js`, default is access from localhost only (Issue [#456](https://github.com/DiscoverITLLC/MagicMirror/issues/456)).
- Added ability to change the point of time when calendar events get relative.
- Add Splash screen on boot.
- Add option to show humidity in currentWeather module.
- Add VSCode IntelliSense support.
- Module API: Add Visibility locking to module system. [See documentation](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules#visibility-locking) for more information.
- Module API: Method to overwrite the module's header. [See documentation](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules#getheader) for more information.
- Module API: Option to define the minimum MagicMirror version to run a module. [See documentation](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules#requiresversion) for more information.
- Calendar module now broadcasts the event list to all other modules using the notification system. [See documentation](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules/default/calendar) for more information.
- Possibility to use the calendar feed as the source for the weather (currentweather & weatherforecast) location data. [See documentation](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules/default/weatherforecast) for more information.
- Added option to show rain amount in the weatherforecast default module
- Add module `updatenotification` to get an update whenever a new version is available. [See documentation](https://github.com/DiscoverITLLC/MagicMirror/tree/develop/modules/default/updatenotification) for more information.
...
- Append endpoints of weather modules with `/` to retrieve the correct data. (Issue [#337](https://github.com/DiscoverITLLC/MagicMirror/issues/337))
- Corrected grammar in `module.js` from 'suspend' to 'suspended'.
- Fixed openweathermap.org URL in config sample.
- Prevent currentweather module from crashing when received data object is incorrect.
- Fix issue where translation loading prevented the UI start-up when the language was set to 'en'. (Issue [#388](https://github.com/DiscoverITLLC/MagicMirror/issues/388))
...
- Edit Alert Module to display title & message if they are provided in the notification (Issue [#300](https://github.com/DiscoverITLLC/MagicMirror/issues/300))
- Removed 'null' reference from updateModuleContent(). This fixes recent Edge and Internet Explorer browser displays (Issue [#319](https://github.com/DiscoverITLLC/MagicMirror/issues/319))
...
- Added the missing NE translation to all languages. [#344](https://github.com/DiscoverITLLC/MagicMirror/issues/344)
